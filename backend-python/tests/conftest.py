...
"""
import os
import datetime  # Added to generate proper native Python date objects
import tempfile
...
# CRITICAL: Import all model namespaces explicitly so SQLAlchemy's metadata 
# registry cleanly knows about the schemas before building the in-memory SQLite tables!
...
def sample_expense_data() -> dict:
    """Create sample expense data for testing. Keep as ISO strings for JSON serialization."""
    return {
        "amount": 75.50,
        "is_income": False,
        "category": "Food & Dining",
        "description": "Restaurant dinner",
        "date": "2024-01-15", # Keep as string! TestClient handles serialization, Pydantic converts it to a date object.
        "account_id": "test_account_001",
    }
...
def sample_income_data() -> dict:
    ...
    return {
        ...
        "date": "2024-01-01", # Keep as string!
        "account_id": "test_account_001",
    }
